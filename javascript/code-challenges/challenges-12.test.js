...
const replaceZeros = (string) => {
  let myregex = /0/g;
  return  string.replace(myregex, 'zero');
  // Solution code here...
};
...
const validatePin = (pin) => {
  let myregex = /^\d{4}$/;
  let nums = myregex.test(pin) ?  true: false;
  return nums
  // Solution code here...
};
...
const validateWord = (word) => {
  let myregex = /^[a-zA-Z]{5,10}$/;
  let verify = myregex.test(word) ?  true: false;
  return verify;
  // Solution code here...
};
...
const hasNumber = (string) => {
  let myregex = /[a-zA-Z][0-9]/;
  let words = myregex.test(string) ?  true: false;
return words;
  // Solution code here...
};
...
const validateEmail = (email) => {
  let myregex = /^\w+(\.\w+)?@\w+\.(net|org|com)$/;
  return myregex.test(email) ?  true: false;
  // Solution code here...
};
...
const validatePhoneNumber = (phoneNumber) => {
  let myregex = /^((\(\d{3}\))|(\d{3}))[ -]?\d{3}[ -]?\d{4}$/;
  return myregex.test(phoneNumber) ?  true: false;
  // Solution code here...
};
